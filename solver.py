...
class Solver(object):
    ...
    def build_model(self):
        ...
        # instantiate ZFNetLite model
        self.model = ZFNetLite(self.input_channels, self.class_count)
        ...
        # print networks
        self.print_network(self.model, 'ZFNetLite')
